...
Rem this script run the cmake configuration script and compiles the project into an executable

Rem cmake -E env LDFLAGS="-fuse-ld=lld-link" PATH="C:\ProgramData\chocolatey\lib\ninja\tools"
